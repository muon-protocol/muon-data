...
//    }
    ...
    @Bean
    public SubgraphService subgraphService(@Value("${nft.subgraph-endpoint}") String endpoint, ObjectMapper objectMapper)
    {
        return new SubgraphService(endpoint, objectMapper);
    }
}
